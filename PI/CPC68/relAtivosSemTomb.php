...
<head>
	<meta charset="UTF-8">
	<title>Relátorio - Ativos Sem Tombamento - CPC68</title>
        ...
        <div class="mainContainer">
        	<div class="mainConteudo">
                	<div class="botoes">
                		...
                		<a href="relAtivosSemTombPDF.php?idUnidade=<?php echo $idUnidade;?>" class="btPesquisar" style="float: right;" target="_blank"><img src="img/printer.png" alt="">Gerar Relatório em PDF</a>
                	</div>
            	<?php
                $Ativo = new Ativo();
                $AtivoRepositorio = new AtivoRepositorio();
                
                $listaAtivo = $AtivoRepositorio->relListarAtivosSemTomb($idUnidade);
                $quantidadeAtivo = $AtivoRepositorio->relContarAtivosSemTomb($idUnidade);
            	?>
            	<table>
            		<tr>
            			<td colspan="7" style="color: #fca235; font-weight: bold; font-size:20px;">Relatório - Ativos sem tombamento em <?php echo $listaAtivo[0]->getAmbiente()->getUnidade()->getNome();?>
            			</td>
            		</tr>
            		<tr>
