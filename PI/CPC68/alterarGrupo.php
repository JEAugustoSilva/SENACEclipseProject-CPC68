	...
	<div id="main">
    	<div class="mainContainer">
    		<div class="mainConteudo">
            	<form action="alterarGrupo2.php" method="post">
                	<div class="botoes">
        				<a href="telaPrincipal.php" class="btVoltar"><img src="img/arrow_left.png" alt="">Voltar</a>
        				<input type="text" name="nome" size="60" > <button class="btPesquisar" type="submit" value="Pesquisar"><img alt="" src="img/magnifier.png"></button>
                		<p>
            	...
            	<table>
            		<tr>
            			...
            			while ($c < $quantidade) {
            			    $Grupo = $listaGrupo[$c];
            			    echo "<tr>";
            			    echo "<td><img alt='' src='img/bullet_go.png'>&nbsp;<a href='alterarGrupo2.php?nome=" . $Grupo->getNome() . "'>" . $Grupo->getNome() . "&nbsp;</td>";
