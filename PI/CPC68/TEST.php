...
// HEADER
    function Header()
    {
    	...
    	$this->Cell(80,10,iconv('utf-8','iso-8859-1','Relatório de Ativos Ausentes'),0,0,'L');
    	$this->SetFont('Arial','B',12);
    	$this->Cell(0,10,iconv('utf-8','iso-8859-1','Data: ' . date("Y/m/d")),0,1,'R');
    	$this->SetFont('Arial','B',10);
    	$this->Cell(50);
    	$this->Cell(0,5,iconv('utf-8','iso-8859-1','Emissor: ' . $_SESSION['nome']),0,1,'L');
    
    	$this->Ln(5);
    	
    	$this->SetFont('Arial','B',8);
    	$this->Cell(27,5,iconv('utf-8','iso-8859-1','Nome'),'B',0,'C');
    	$this->Cell(27,5,iconv('utf-8','iso-8859-1','Tombamento'),'B',0,'C');
    	$this->Cell(27,5,iconv('utf-8','iso-8859-1','Subgrupo'),'B',0,'C');
    	$this->Cell(27,5,iconv('utf-8','iso-8859-1','Ambiente'),'B',0,'C');
    	$this->Cell(27,5,iconv('utf-8','iso-8859-1','Data de registro'),'B',0,'C');
    	$this->Cell(27,5,iconv('utf-8','iso-8859-1','Cadastrante'),'B',0,'C');
    	$this->Cell(0,5,iconv('utf-8','iso-8859-1','Status'),'B',1,'C');
    }
...
while ($c < $quantidadeAtivo) {
	...
	$pdf->Cell(27,7,utf8_decode(custom_echo($listaAtivo[$c]->getDtRegistro(),20)),'BL',0,'C');
