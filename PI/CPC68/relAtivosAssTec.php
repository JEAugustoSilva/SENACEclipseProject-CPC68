        ...
        <div class="mainContainer">
        	<div class="mainConteudo">
                	<div class="botoes">
                		...
                		<a href="relAtivosAssTecPDF.php?idUnidade=<?php echo $idUnidade;?>" class="btPesquisar" style="float: right;" target="_blank"><img src="img/printer.png" alt="">Gerar Relatório em PDF</a>
                	</div>
            	<?php
                $Ativo = new Ativo();
            	...
            	<table>
            		<tr>
            			<td colspan="7" style="color: #fca235; font-weight: bold; font-size:20px;">Relatório - Ativos de <?php echo $listaAtivo[0]->getAmbiente()->getUnidade()->getNome();?> em Ass. Técnica
            			</td>
            		</tr>
            		<tr>
