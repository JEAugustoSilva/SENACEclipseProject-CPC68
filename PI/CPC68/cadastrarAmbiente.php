...
<head>
	<meta charset="UTF-8">
	<title>Cadastro Ambiente - CPC68</title>
	...
	<div id="main">
		<div class="mainContainer">
        	<div class="mainConteudo">
            	<form action="cadastrarAmbiente2.php" method="post">
            		<table class="form">
            			<tr>
            				<td>
            			...
            			<tr>
            				...
            				<td>
                    			<input type="text" name="codigoBarra" size="25" maxlength="10" placeholder="Max: 10 caracteres" required>
            				</td>
            			</tr>
            			<tr>
            				<td>
            				...
            				<td>
                    			<select name="idUnidade" required>
                    				<option value="0" hidden="true" disabled selected>Selecione uma unidade</option>
                    					<?php
                                        $c = 0;
