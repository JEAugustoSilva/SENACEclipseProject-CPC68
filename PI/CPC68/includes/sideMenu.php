<div id="sideMenu" class="sideMenu">
	<div style="border-bottom: 1px solid #ccc; display: block; margin: 10px 0;">
	</div>
	<button class="btDropdown">Ativo <i class="arrow down"></i></button>
	<div class="dropdown-container">
		<a href="cadastrarAtivo.php">Cadastro</a>
	...
	<div class="dropdown-container">
		<a href="movimentacao1.php">Cadastro</a>
		<a href="consultarMovimentacao.php">Consulta</a>
	</div>
	<div style="border-bottom: 1px solid #ccc; display: block; margin: 10px 0;">
	</div>
	...
	<div class="dropdown-container">
		...
		<a href="consultarCargo.php">Consulta</a>
	</div>
	<div style="border-bottom: 1px solid #ccc; display: block; margin: 10px 0;">
	</div>
