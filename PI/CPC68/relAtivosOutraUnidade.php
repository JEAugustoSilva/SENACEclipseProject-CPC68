...
<head>
	<meta charset="UTF-8">
	<title>Relátorio - Ativos em Outra Unidade - CPC68</title>
        ...
        <div class="mainContainer">
        	<div class="mainConteudo">
                	<div class="botoes">
                		...
                		<a href="relAtivosOutraUnidadePDF.php?idUnidade=<?php echo $idUnidade;?>" class="btPesquisar" style="float: right;" target="_blank"><img src="img/printer.png" alt="">Gerar Relatório em PDF</a>
                	</div>
            	<?php
                $Ativo = new Ativo();
                $AtivoRepositorio = new AtivoRepositorio();
                
                list($listaAtivo, $nomeAmbienteDestino, $nomeUnidadeDestino, $movDtRetorno) = $AtivoRepositorio->relListarAtivosOutraUnidade($idUnidade);
                $quantidadeAtivo = $AtivoRepositorio->relContarAtivosOutraUnidade($idUnidade);
            	?>
            	<table>
            		<tr>
            			<td colspan="8" style="color: #fca235; font-weight: bold; font-size:20px;">Relatório - Ativos de <?php echo $listaAtivo[0]->getAmbiente()->getUnidade()->getNome();?> em Outra Unidade
            			</td>
            		</tr>
            		<tr>
                  ...
                  <!--  <td style="color: #fca235; font-weight: bold;">Subgrupo</td>    -->
                        ...
                        <td style="color: #fca235; font-weight: bold;">Unidade destino</td>
                        <td style="color: #fca235; font-weight: bold;">Data de retorno</td>
...
//                         echo "<td>&nbsp;" . $Ativo->getSubgrupo()->getNome() . "&nbsp;</td>";
                        ...
                        echo "<td>&nbsp;" . $nomeAmbienteDestino[$c] . "&nbsp;</td>";
                        echo "<td>&nbsp;" . $nomeUnidadeDestino[$c] . "&nbsp;</td>";
                        echo "<td>&nbsp;" . date('d/m/Y - H:i',strtotime($movDtRetorno[$c])) . "&nbsp;</td>";
