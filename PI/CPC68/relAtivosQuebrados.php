...
<head>
	<meta charset="UTF-8">
	<title>Relátorio - Ativos Quebrados - CPC68</title>
        ...
        <div class="mainContainer">
        	<div class="mainConteudo">
                	<div class="botoes">
                		...
                		<a href="relAtivosQuebradosPDF.php?idUnidade=<?php echo $idUnidade;?>" class="btPesquisar" style="float: right;" target="_blank"><img src="img/printer.png" alt="">Gerar Relatório em PDF</a>
                	</div>
            	<?php
                $Ativo = new Ativo();
                $AtivoRepositorio = new AtivoRepositorio();
                
                $listaAtivo = $AtivoRepositorio->relListarAtivosQuebrados($idUnidade);
                $quantidadeAtivo = $AtivoRepositorio->relContarAtivosQuebrados($idUnidade);
            	?>
            	<table>
            		<tr>
