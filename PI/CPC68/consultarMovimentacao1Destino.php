        	...
        	<div class="mainConteudo">
				<form action="consultarMovimentacao2.php" method="post">
                	<div class="botoes">
            			...
            			<input type="hidden" name="OouD" value="D">
                ...
                $listaMov = $MovimentacaoRepositorio->listarMovimentacaoPorAmbienteDestinoDesbloqueado($idAmbiente);
                $quantidadeMov = $MovimentacaoRepositorio->contarMovimentacaoPorAmbienteDestinoDesbloqueado($idAmbiente);
            	?>
            	<table>
            		<tr>
            		...
            		while ($c < $quantidadeMov) {
            		    ...
            		    echo "<tr class='trLink' data-href='consultarMovimentacao2.php?OouD=D&id=" . $Movimentacao->getId() . "&idUnidade=" . $idUnidade . "&nomeUnidade=" . $nomeUnidade . "&idAmbiente=" . $idAmbiente . "&nomeAmbiente=" . $nomeAmbiente . "'>";
                        ...
                        echo "<td>&nbsp;" . $Movimentacao->getAmbienteDestino()->getNome() . "&nbsp;</td>";
//                         echo "<td>&nbsp;" . date('d/m/Y - H:i',strtotime($Movimentacao->getDtRegistro())) . "&nbsp;</td>";
                        echo "<td>&nbsp;" . $Movimentacao->getDtRegistro() . "&nbsp;</td>";
