	...
	<div id="main">
		<div class="mainContainer">
    		<div class="mainConteudo">
        		<form action="alterarFuncionario2.php" method="post">
        			<div class="botoes">
				...
				<table>
            		...
            		while ($c < $quantidadeFuncionario) {
            		  echo "<tr>";
            		  echo "<td><img alt='' src='img/bullet_go.png'>&nbsp;<a href='alterarFuncionario2.php?pesquisa=" . $listaFuncionario[$c]->getNome() . "'>" . $listaFuncionario[$c]->getNome() ."</td>";
