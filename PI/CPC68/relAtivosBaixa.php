...
<head>
	<meta charset="UTF-8">
	<title>Relátorio - Ativos em Baixa - CPC68</title>
        ...
        <div class="mainContainer">
        	<div class="mainConteudo">
                	<div class="botoes">
                		...
                		<a href="relAtivosBaixaPDF.php?idUnidade=<?php echo $idUnidade;?>" class="btPesquisar" style="float: right;" target="_blank"><img src="img/printer.png" alt="">Gerar Relatório em PDF</a>
                	</div>
            	<?php
                $Ativo = new Ativo();
                $AtivoRepositorio = new AtivoRepositorio();
                
                $listaAtivo = $AtivoRepositorio->relListarAtivosBaixa($idUnidade);
                $quantidadeAtivo = $AtivoRepositorio->relContarAtivosBaixa($idUnidade);
            	?>
            	<table>
            		<tr>
            			<td colspan="7" style="color: #fca235; font-weight: bold; font-size:20px;">Relatório - Ativos de <?php echo $listaAtivo[0]->getAmbiente()->getUnidade()->getNome();?> em Baixa
            			</td>
            		</tr>
            		<tr>
