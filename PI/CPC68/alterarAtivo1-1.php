        	...
        	<div class="mainConteudo">
				<form action="alterarAtivo2.php" method="post">
            		<div class="botoes">
            			...
            			<input type="text" name="pesquisa" size="60" placeholder="Pesquisar o ativo pelo tombamento" required> <button class="btPesquisar" type="submit" value="Pesquisar"><img alt="" src="img/magnifier.png"></button>
                	</div>
            		<p>
            			<?php
            	...
            	<table>
            		<tr>
            			<td colspan="3" style="color: #fca235; font-weight: bold; font-size:20px;"><a href="alterarAtivo.php">Unidades</a> > Ambientes de <?php echo $nomeUnidade;?></td>
            		</tr>
            		<tr>
            		...
            		while ($c < $quantidadeAmbiente) {
                        ...
                        echo "<tr>";
                        echo "<td><img alt='' src='img/bullet_go.png'>&nbsp;<a href='alterarAtivo1-2.php?idUnidade=" . $idUnidade . "&idAmbiente=" . $Ambiente->getId() . "&nomeUnidade=" . $nomeUnidade . "&nomeAmbiente=" . $Ambiente->getNome() . "'>" . $Ambiente->getNome() ."</td>";
