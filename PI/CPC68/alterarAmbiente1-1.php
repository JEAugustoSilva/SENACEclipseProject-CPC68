	...
	<div id="main">
    	<div class="mainContainer">
    		<div class="mainConteudo">
            	<form action="alterarAmbiente2.php" method="post">
            		<div class="botoes">
            	...
            	<table>
            		<tr>
            			<td colspan="3" style="color: #fca235; font-weight: bold; font-size:20px;"><a href="alterarAmbiente.php">Unidades</a> > Ambientes de <?php echo $nomeUnidade;?></td>
            		</tr>
            		<tr>
            		...
            		while ($c < $quantidadeAmbiente) {
                        ...
                        echo "<tr>";
                        echo "<td><img alt='' src='img/bullet_go.png'>&nbsp;<a href='alterarAmbiente2.php?pesquisa=" . $Ambiente->getNome() . "'>" . $Ambiente->getNome() ."</td>";
