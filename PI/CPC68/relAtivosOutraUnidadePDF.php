...
// HEADER
    function Header()
    {
    	...
    	$this->Cell(50);
    	$this->Cell(80,10,utf8_decode('Relatório de Ativos em Empréstimo'),0,0,'L');
...
//     	$this->Cell(27,5,utf8_decode('Subgrupo'),'B',0,'C');
    	$this->Cell(27,5,utf8_decode('Ambiente origem'),'B',0,'C');
    	$this->Cell(27,5,utf8_decode('Ambiente destino'),'B',0,'C');
    	$this->Cell(27,5,utf8_decode('Unidade destino'),'B',0,'C');
    	$this->Cell(27,5,utf8_decode('Data de retorno'),'B',0,'C');
...
// 	$pdf->Cell(27,7,utf8_decode(custom_echo($listaAtivo[$c]->getSubgrupo()->getNome(),20)),'BL',0,'C');
	...
	$pdf->Cell(27,7,utf8_decode(custom_echo($nomeAmbienteDestino[$c],20)),'BL',0,'C');
	$pdf->Cell(27,7,utf8_decode(custom_echo($nomeUnidadeDestino[$c],20)),'BL',0,'C');
	$pdf->Cell(27,7,utf8_decode(custom_echo(date('d/m/Y - H:i',strtotime($movDtRetorno[$c])),20)),'BL',0,'C');
...
$pdf->Output('I','RelatorioAtivoOutroAmbente'.date("d_m_Y").'.pdf',true);
?>
