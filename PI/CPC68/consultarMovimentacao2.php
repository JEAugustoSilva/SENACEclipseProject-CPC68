                        				...
                        				<?php // BOTAO VOLTAR
               						    if (isset($_GET['1_1']) || isset($_POST['1_1'])) {
               						        ...
               						        if ($OrigemOuDestino == "O") {
               						            echo '<a href="consultarMovimentacao1Origem.php?idUnidade=' . $idUnidade . '&idAmbiente=' . $idAmbiente . '&nomeUnidade=' . $nomeUnidade . '&nomeAmbiente=' . $nomeAmbiente . '" class="btVoltar"><img src="img/arrow_left.png" alt="">Voltar</a>';
               						        } else if ($OrigemOuDestino == "D") {
               						            echo '<a href="consultarMovimentacao1Destino.php?idUnidade=' . $idUnidade . '&idAmbiente=' . $idAmbiente . '&nomeUnidade=' . $nomeUnidade . '&nomeAmbiente=' . $nomeAmbiente . '" class="btVoltar"><img src="img/arrow_left.png" alt="">Voltar</a>';
               						        }
               						    }
                        				?>
