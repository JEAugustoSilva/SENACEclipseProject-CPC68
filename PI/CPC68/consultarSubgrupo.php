	...
	<div id="main">
		<div class="mainContainer">
    		<div class="mainConteudo">
				<form action="consultarSubgrupo2.php" method="post">
					<div class="botoes">
				...
				<table>
            		...
            		while ($c < $quantidadeGrupo) {
            		    $Grupo = $listaGrupo[$c];
            		  echo "<tr>";
            		  echo "<td><img alt='' src='img/bullet_go.png'>&nbsp;<a href='consultarSubgrupo1-1.php?idGrupo=" . $Grupo->getId() . "&nomeGrupo=" . $Grupo->getNome() . "'>" . $Grupo->getNome() ."</td>";
