	...
	<div id="main">
    	<div class="mainContainer">
    		<div class="mainConteudo">
            	<form action="alterarUnidade2.php" method="post">
            		<div class="botoes">
            ...
            <?php 
                ...
                if ($_SESSION['nivel'] == 1 || $_SESSION['nivel'] == 2) {
                    ...
                    $quantidade = $UnidadeRepositorio->listarUnidadeDesbloqueado();
                }
            ?>
            	<table>
            		<tr>
            			...
            			<td style="color: #fca235; font-weight: bold;">Enderço</td>
            			...
            			while ($c < $quantidade) {
            			    ...
            			    echo "<tr>";
            			    echo "<td><img alt='' src='img/bullet_go.png'>&nbsp;<a href='alterarUnidade2.php?pesquisa=" . $Unidade->getNome() . "'>" . $Unidade->getNome() . "&nbsp;</td>";
