            	...
            	<table>
            		...
            		while ($c < $quantidadeAtivo) {
                        ...
                        if ($_SESSION['nivel'] != 1 && $_SESSION['nivel'] != 2) {
                            ...
                            echo "<td><img alt='' src='img/bullet_go.png'>&nbsp;<a href='alterarAtivo2.php?pesquisa=" . $Ativo->getCodigoBarra() . "&idUnidade=" . $idUnidade . "&nomeUnidade=" . $nomeUnidade . "'>" . $Ativo->getNome() ."</td>";
                        }
